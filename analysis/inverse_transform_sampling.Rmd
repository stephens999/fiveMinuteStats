...
Assume $Y$ is an exponential random variable with rate paramter $\lambda = 2$. Recall that the probability density function is $p(y) = 2e^{-2y}$, for $y > 0$. First, we compute the CDF:
