...
Be familiar with the [likelihood ratio for discrete data](likelihood_ratio_simple_models.html) and [continuous data](likelihood_ratio_simple_continuous_data.html).
...
Consider comparing the models $M_0$: the die is fair (ie each face has probability 1/6) vs
