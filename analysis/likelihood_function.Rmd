...
Notice that the scale of the $y$ axis in this plot was set to span 10 log likelihood units. Setting the scale in this way makes sure the plot focusses on the parts of the parameter space that have more than miniscule support from the data (in this case, LR no smaller than 1/exp(10)). Without this the
