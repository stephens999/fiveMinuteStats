...
`x`,  the allelel frequencies `P` and the mixture proportions `w`.  Apply your function to the simulated data.

3. Write a function `posterior_prob_allele_frequencies=function(x,z,a)` to compute the parameters of the beta posterior in each population at each locus.
