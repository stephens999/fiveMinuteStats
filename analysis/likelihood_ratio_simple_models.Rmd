...
where $p(\cdot | M)$ denotes the probabilty mass function for model $M$. And the likelihood ratio comparing two fully-specified (discrete) models 
$M_1$ vs $M_0$ is defined as
